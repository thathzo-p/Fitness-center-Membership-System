...
<div class="booking-form-page">
    ...
    <div class="booking-form-card">
        ...
        <p>Choose your preferred fitness class and time slot.</p>

        <form action="/booking/create" method="post">

            <input type="text" name="memberName" placeholder="Your Name" required>
        ...
        <a href="/booking/my" class="back-link">Back to My Bookings</a>
